<div class="header-fixed">
  <div class="header-inner">
    ...
    <a class="logo" href="index.php">
      <img class="desktop" src='img/logo.svg' alt='logo'>
      <img class="mobile" src='img/mini-logo.svg' alt='logo mini'>
    </a>
      ...
      <div class="address">
        ...
        <div class="address-block">
          ...
          <ul class="address-select">
            ...
            <li class="address-cont">
              <a href="#">
                <p><b>м. Ів-Франківськ</b>, вул. Вовчинецька, 124</p>
              </a>
            </li>
            <li class="address-cont">
              <a href="#">
                <p><b>м. Хмельницький</b>, вул. Інститутська 13А</p>
              </a>
            </li>
          </ul>
        </div>
